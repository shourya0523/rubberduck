#!/usr/bin/env node
/**
 * Split source/duck-anim.webp into one-shot state WebPs + posters.
 ...
 *   excited  150–173
 *
 * WebPs use loop=1 (play once). UI shows posters at rest.
 */
...
for name, rng in ranges.items():
    ...
    imgs[0].save(dest, save_all=True, append_images=imgs[1:], duration=duration, loop=1, lossless=False, quality=80, method=4)
    imgs[0].convert("RGB").save(out_dir / f"duck-{name}-poster.jpg", quality=88)
